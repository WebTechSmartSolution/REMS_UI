...
const DashboardPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const forRent = response.filter((listing) => listing.type === "Apartment").length; // Mock logic
    ...
    const COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FE8042"];
    ...
    const imageBodyTemplate = (rowData) => <img src={rowData.images?.[0]} alt={rowData.title} className="w-6rem h-4rem" />;
    ...
    return (
        <div className="dashboard">
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                        <Pie
                            ...
                            labelLine={false}  // Remove the label line for a cleaner look
                        >
            ...
            <div className="table-container">
                {header}
                <DataTable value={listings} paginator rows={10} loading={loading}>
