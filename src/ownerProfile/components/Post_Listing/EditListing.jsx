...
// console.log(listingData)
  // Initialize formData with the data passed via props (listingData)
  const [formData, setFormData] = useState({
    ...
    propertyDetails: {
      ...
      pricePerSqft: listingData?.pricePerSqft || "",
      structureType: listingData?.structureType || "",
      noOfBedrooms: listingData?.noOfBedrooms || "",
      noOfBathrooms: listingData?.noOfBathrooms || "",
      sqft: listingData?.sqft || "",
      noOfFloors: listingData?.noOfFloors || "",
      garageSize: listingData?.garageSize || "",
      yearConstructed: listingData?.yearConstructed || "",
      Description: listingData?.Description || "",
    },
    amenities: {
      airConditioning: listingData?.airConditioning || false,
      lawn: listingData?.lawn || false,
      swimmingPool: listingData?.swimmingPool || false,
      barbecue: listingData?.barbecue || false,
      microwave: listingData?.microwave || false,
      tvCable: listingData?.tvCable || true,
      dryer: listingData?.dryer || false,
      wifi: listingData?.wifi || true,
    },
    ContactInfo: {
  ...
  const handleSubmit = async () => {
    const newErrors = {
      ...
      propertyDetails: {
        ...
        pricePerSqft: !formData.propertyDetails.pricePerSqft,
        noOfBedrooms: !formData.propertyDetails.noOfBedrooms,
        noOfBathrooms: !formData.propertyDetails.noOfBathrooms,
        sqft: !formData.propertyDetails.sqft,
        noOfFloors: !formData.propertyDetails.noOfFloors,
        garageSize: !formData.propertyDetails.garageSize,
        yearConstructed: !formData.propertyDetails.yearConstructed,
    ...
    if (!hasErrors) {
      try {
        ...
        const response = await authService.UpdateListing(listingData.id,form);
        notify("success", "Listing Updated Successfully" + response.data.message);
        handleReset();
      } catch (error) {
