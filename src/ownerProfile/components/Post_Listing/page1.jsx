    ...
    <div className="Parent_Main">
            ...
            <div className="info-inputs">
              ...
              <div className="info-form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("propertyInfo", "propertyType", e.target.value)
                  }
                >
              ...
              <div className="info-form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("propertyInfo", "currencyType", e.target.value)
                  }
                >
              ...
              <div className="info-form-group">
                ...
                {errors.propertyInfo.salePrice && (
                  <span className="error-message">Sale Price is required.</span>
                )}
              </div>
        ...
        <div className="amenities-container">
          ...
          <div className="amenities-description">
            ...
            <p>
              ...
              features can make your listing more attractive to potential buyers
              or renters.
            </p>
          </div>
            ...
            <div className="amenities-grid">
              ...
              <div className="amenity-item">
                <input
                  ...
                  onChange={(e) =>
                    handleChange("amenities", "swimmingPool", e.target.checked)
                  }
                />
          ...
          <div className="form-group-row">
            ...
            <div className="form-group">
              ...
              {errors.description?.garageSize && (
                <span className="error-message">Garage size is required.</span>
              )}
            </div>
          </div>
      ...
      <div className="properties-location-section" id="location">
        <div className="left-column">
          ...
          <p className="section-info">
            Provide the detailed location of the property to help tenants easily
            locate it.
          </p>
        </div>
